...
public class MembersDisplay extends AbstractPage implements Observer {
	
	/* Singleton */
	private static MembersDisplay instance;
	public static MembersDisplay get() {
		if(instance == null)
			instance = new MembersDisplay((int)(0.78*WIDTH), (int)(0.65*HEIGHT));
	...
	/* Constructor */
	private MembersDisplay(int width,int height) {
		super(width,height);
